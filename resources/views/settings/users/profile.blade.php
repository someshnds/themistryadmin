...
@push('css_lib')
    ...
    <link rel="stylesheet" href="{{asset('public/vendor/summernote/summernote-lite.min.css')}}">
    {{--dropzone--}}
...
@push('scripts_lib')
    ...
    <script src="{{asset('public/vendor/summernote/summernote-lite.min.js')}}"></script>
    {{--dropzone--}}
