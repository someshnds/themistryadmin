        ...
        <div class="card-header">
            <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                @foreach($languages as $code => $language)
                    <li class="nav-item">
                        <a class="nav-link @if($tab === $code) active @endif" href="{!! url('settings/translation/'.$code) !!}"><i class="fas fa-language mr-2"></i>{{trans('lang.app_setting_'.$code)}}
                        </a>
                    </li>
                @endforeach
                {{--                <div class="ml-auto d-inline-flex">--}}
                {{--                    <li class="nav-item">--}}
                {{--                        <a class="nav-link pt-1" href="{{url('settings/sync-translation')}}"><i class="fas fa-redo-alt"></i> {{trans('lang.sync_translation')}}--}}
                {{--                        </a>--}}
                {{--                    </li>--}}
                {{--                </div>--}}
            </ul>
            ...
            <div class="row">
                <div class="col-3 nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    @foreach($langFiles as $filename => $lang)
                        <a class="nav-link" id="v-pills-{{$filename}}-tab" data-toggle="pill" href="#v-pills-{{$filename}}" role="tab" aria-controls="v-pills-{{$filename}}">{{Str::title($filename)}}</a>
                    @endforeach
                </div>
                ...
                <div class="form-group mt-4 col-12 text-right">
                    <button type="submit" class="btn bg-{{setting('theme_color')}} mx-md-3 my-lg-0 my-xl-0 my-md-0 my-2">
                        <i class="fas fa-save"></i> {{trans('lang.save')}} {{trans('lang.app_setting_translation')}}</button>
