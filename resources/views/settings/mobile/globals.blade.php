...
@push('css_lib')
    ...
    {{--Color Picker--}}
    <link rel="stylesheet" href="{{asset('public/vendor/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')}}">
@endpush
...
@push('scripts_lib')
    ...
    <script src="{{asset('public/vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js')}}"></script>
