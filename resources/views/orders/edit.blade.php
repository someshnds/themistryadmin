        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @can('bookings.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('bookings.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.booking_create')}}</a>
                        </li>
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-pencil mr-2"></i>{{trans('lang.booking_edit')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
