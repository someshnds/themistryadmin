...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6">
                    <h1 class="m-0 text-bold">{{trans('lang.favorite_plural')}} <small class="mx-3">|</small><small>{{trans('lang.favorite_desc')}}</small></h1>
                </div><!-- /.col -->
                <div class="col-md-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{!! route('favorites.index') !!}">{{trans('lang.favorite_plural')}}</a>
                        </li>
